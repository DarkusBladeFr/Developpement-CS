...
namespace TDCSalleCinema
{
    class Program
    {
        ...
        //Constructeur
        public Program(string titreDuFilm, int nombreSiege, double prixTarifNormal)
        {
        ...
        {
            string titreDuFilm="";
            int nombreSiege=0 , nombreVenteNormal=0 , nombreVenteReduit=0;
            double prixTarifNormal=0;
            affiche(titreDuFilm, nombreSiege, prixTarifNormal, nombreVenteNormal, nombreVenteReduit);
            Console.ReadLine();
        }
    }
}
